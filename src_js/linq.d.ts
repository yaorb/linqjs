declare namespace Enumerable {
  ...
  export function asEnumerable<T, TValue>(
    obj: object,
    childrenSelector: (
      element: T,
    ) => T[] | IEnumerable<T> = defaultChildrenSelector,
    valueSelector: (element: T) => TValue = defaultValueSelector,
  ): ITree<TValue>;
  export function asEnumerable<T, TValue>(
    obj: object,
    childrenSelector: string | number | symbol,
    valueSelector: (element: T) => TValue = defaultValueSelector,
  ): ITree<T>;
  export function asEnumerable<T, TValue>(
    obj: object,
    ...
    valueSelector: string | number | symbol,
  ): ITree<TValue>;
  export function asEnumerable<T, TValue>(
    obj: object,
    childrenSelector: string | number | symbol,
  ...
  export function where<T>(
    ...
    predicate: (element: T, index?: number) => boolean = defaultPredicate,
  ): IEnumerable<T>;
  export function where<T>(
    source: T[] | IEnumerable<T>,
    predicate: string | number | symbol | T | any,
  ): IEnumerable<T>;

  export function select<T, TResult>(
    source: T[] | IEnumerable<T>,
    selector: (element: T, index?: number) => TResult = defaultSelector,
  ): IEnumerable<TResult>;
  export function select<T, TResult>(
    source: T[] | IEnumerable<T>,
  ...
  export function aggregate<T, TSeed, TResult>(
    source: T[] | IEnumerable<T>,
    seed: TSeed,
    func: (seed: TSeed, element: T, index?: number) => TSeed,
    resultSelector: (result: TSeed) => TResult = defaultSelector,
  ): TResult;
  export function aggregate<T, TSeed, TResult>(
    source: T[] | IEnumerable<T>,
    seed: TSeed,
    func: (seed: TSeed, element: T, index?: number) => TSeed,
    resultSelector: string | number | symbol,
  ): TResult;
  ...
  export function average<T>(
    source: T[] | IEnumerable<T>,
    selector: (element: T, index?: number) => number = defaultSelector,
  ): number;
  export function average<T>(
    source: T[] | IEnumerable<T>,
    selector: string | number | symbol,
  ...
  export function split<T>(
    ...
    splitPredicate: (
      element: T,
      index?: number,
    ) => boolean = defaultFalsePredicate,
  ): IEnumerable<IChunk<T>>;
  export function split<T>(
    source: T[] | IEnumerable<T>,
    splitPredicate: string | number | symbol | T | RegExp | any,
  ): IEnumerable<IChunk<T>>;

  export function nearSplit<T>(
    source: T[] | IEnumerable<T>,
    splitPredicate: (
      element: T,
      index?: number,
  ...
  export function contains<T, TOther>(
    source: T[] | IEnumerable<T>,
    value: TOther,
    comparer: (element: T, other: TOther) => boolean = defaultEqualityComparer,
  ): boolean;
  export function contains<T, TOther>(
    source: T[] | IEnumerable<T>,
    value: TOther,
  ...
  export function distinct<T>(
    source: T[] | IEnumerable<T>,
    comparer: (element: T, other: T) => boolean = defaultEqualityComparer,
  ): IEnumerable<T>;
  export function distinct<T>(
    source: T[] | IEnumerable<T>,
    comparer: string | number | symbol,
  ...
  export function every<T>(
    source: T[] | IEnumerable<T>,
    callback: (element: T, index?: number, source?: IEnumerable<T>) => boolean,
    thisArg?: any,
  ): boolean;

  export function except<T, TOther>(
    source: T[] | IEnumerable<T>,
    other: TOther[] | IEnumerable<TOther>,
    comparer: (element: T, other: TOther) => boolean = defaultEqualityComparer,
  ): IEnumerable<T>;
  export function except<T, TOther>(
    source: T[] | IEnumerable<T>,
  ...
  export function filter<T, TResult>(
    source: T[] | IEnumerable<T>,
    callback: (element: T, index?: number, source?: IEnumerable<T>) => TResult,
    thisArg?: any,
  ): IEnumerable<TResult>;
  ...
  export function forEach<T>(
    source: T[] | IEnumerable<T>,
    action: (element: T, index?: number, source?: IEnumerable<T>) => void,
    thisArg?: any,
  ): void;
  export function forEach<TKey, TValue>(
    source: IMapEnumerable<TKey, TValue>,
    action: (
      element: TValue,
      key: TKey,
      source?: IMapEnumerable<TKey, TValue>,
  ...
  export function indices<T>(
    source: T[] | IEnumerable<T>,
    indices: number[] | IEnumerable<number>,
  ): IEnumerable<T>;
  ...
  export function groupBy<T, TKey, TElement, TResult>(
    source: T[] | IEnumerable<T>,
    keySelector: (element: T, index?: number) => TKey = defaultKeySelector,
    elementSelector: (
      element: T,
      index?: number,
    ) => TElement = defaultValueSelector,
    resultSelector: (
      key: TKey,
      grouping: IGrouping<TKey, TElement>,
    ) => TResult = defaultResultSelector,
    comparer: (key: TKey, other: TKey) => boolean = defaultEqualityComparer,
  ): IEnumerable<TResult>;
  export function groupBy<T, TKey, TElement, TResult>(
    source: T[] | IEnumerable<T>,
    keySelector: string | number | symbol,
    elementSelector: (
      element: T,
      index?: number,
    ) => TElement = defaultValueSelector,
  ...
  export function groupJoin<T, TInner, TOuterKey, TInnerKey, TResult>(
    source: T[] | IEnumerable<T>,
    inner: TInner[] | IEnumerable<TInner>,
    resultSelector: (
      element: T,
      grouping: IGrouping<TOuterKey, TInner>,
    ) => TResult = defaultJoinSelector,
    outerKeySelect: (
      element: T,
      index?: number,
    ) => TOuterKey = defaultKeySelector,
    innerKeySelect: (
      element: TInner,
      index?: number,
    ) => TInnerKey = defaultKeySelector,
    comparer: (
      key: TOuterKey,
      other: TInnerKey,
    ) => boolean = defaultEqualityComparer,
  ): IEnumerable<TResult>;
  export function groupJoin<T, TInner, TOuterKey, TInnerKey, TResult>(
    source: T[] | IEnumerable<T>,
    inner: TInner[] | IEnumerable<TInner>,
    ...
    outerKeySelect: string | number | symbol,
    innerKeySelect: (
      element: TInner,
      index?: number,
    ) => TInnerKey = defaultKeySelector,
  ...
  export function indexOf<T, TOther>(
    source: T[] | IEnumerable<T>,
    element: TOther,
    start: number = 0,
    comparer: (
      element: T,
      other: TOther,
    ) => boolean = defaultStrictEqualityComparer,
  ): number;
  export function indexOf<T, TOther>(
    source: T[] | IEnumerable<T>,
    element: TOther,
  ...
  export function lastIndexOf<T, TOther>(
    source: T[] | IEnumerable<T>,
    element: TOther,
    start: number = 0,
    comparer: (
  ...
  export function innerJoin<T, TInner, TOuterKey, TInnerKey, TResult>(
    source: T[] | IEnumerable<T>,
    inner: TInner[] | IEnumerable<TInner>,
    resultSelector: (
      element: T,
  ...
  export function intersect<T, TOther>(
    source: T[] | IEnumerable<T>,
    other: TOther[] | IEnumerable<TOther>,
    comparer: (element: T, other: TOther) => boolean = defaultEqualityComparer,
  ): IEnumerable<T>;
  ...
  export function join<T, TInner, TOuterKey, TInnerKey, TResult>(
    source: T[] | IEnumerable<T>,
    inner: TInner[] | IEnumerable<TInner>,
    resultSelector: (element: T, other: TInner) => TResult,
    outerKeySelect: (
      element: T,
      index?: number,
    ) => TOuterKey = defaultKeySelector,
  ...
  export function leftJoin<T, TInner, TOuterKey, TInnerKey, TResult>(
    source: T[] | IEnumerable<T>,
    inner: TInner[] | IEnumerable<TInner>,
    resultSelector: (
      element: T,
  ...
  export function rightJoin<T, TInner, TOuterKey, TInnerKey, TResult>(
    source: T[] | IEnumerable<T>,
    inner: TInner[] | IEnumerable<TInner>,
    resultSelector: (
      element: T,
  ...
  export function map<T, TOther>(
    source: T[] | IEnumerable<T>,
    callback: (element: T, index?: number, source?: IEnumerable<T>) => TOther,
    thisArg?: any,
  ): IEnumerable<TOther>;
  ...
  export function max<T>(
    source: T[] | IEnumerable<T>,
    selector: (element: T, index?: number) => string,
  ): T;
  export function max<T>(
    source: T[] | IEnumerable<T>,
    selector: string | number | symbol,
  ): T;
  export function max<T, TResult>(
    source: T[] | IEnumerable<T>,
    selector: (element: T, index?: number) => TResult,
    comparer: (element: TResult, other: TResult) => number,
  ): T;
  export function max<T, TResult>(
    source: T[] | IEnumerable<T>,
    selector: string | number | symbol,
  ...
  export function maxIndex<T, TResult>(
    source: T[] | IEnumerable<T>,
    selector: (element: T, index?: number) => TResult,
    comparer: (element: TResult, other: TResult) => number,
  ): number;
  ...
  export function maxOrDefault<T>(
    source: T[] | IEnumerable<T>,
    defaultValue: T,
    selector: (element: T, index?: number) => number = defaultSelector,
  ): T;
  ...
  export function maxOrDefault<T, TResult>(
    source: T[] | IEnumerable<T>,
    defaultValue: T,
    selector: (element: T, index?: number) => TResult,
    comparer: (element: TResult, other: TResult) => number,
  ...
  export function minIndex<T, TResult>(
    source: T[] | IEnumerable<T>,
    selector: (element: T, index?: number) => TResult,
    comparer: (element: TResult, other: TResult) => number,
  ): number;
  ...
  export function minOrDefault<T>(
    source: T[] | IEnumerable<T>,
    defaultValue: T,
    selector: (element: T, index?: number) => number = defaultSelector,
  ): T;
  ...
  export function minOrDefault<T, TResult>(
    source: T[] | IEnumerable<T>,
    defaultValue: T,
    selector: (element: T, index?: number) => TResult,
    comparer: (element: TResult, other: TResult) => number,
  ...
  export function ofType<T, TResult>(
    source: T[] | IEnumerable<T>,
    type: string,
  ): IEnumerable<TResult>;
  export function ofType<T, TResult>(
  ...
  export function orderBy<T, TKey>(
    source: T[] | IEnumerable<T>,
    keySelector: (element: T, index?: number) => TKey = defaultSelector,
    comparer: (element: T, other: T) => number = defaultComparer,
  ...
  export function randomProbability<T>(
    source: T[] | IEnumerable<T>,
    probabilitySelector: (
      element: T,
      index?: number,
    ) => number = defaultSelector,
  ): T;
  export function randomProbability<T>(
    source: T[] | IEnumerable<T>,
    probabilitySelector: string | number | symbol,
  ): T;

  export function randomIndexProbability<T>(
    source: T[] | IEnumerable<T>,
    probabilitySelector: (
      element: T,
      index?: number,
  ...
  export function randomProbabilityOrDefault<T>(
    source: T[] | IEnumerable<T>,
    defaultValue: T,
    probabilitySelector: (
      element: T,
  ...
  export function reduce<T, TSeed>(
    source: T[] | IEnumerable<T>,
    callback: (seed: TSeed, element: T, index?: number) => TSeed,
    initialValue: TSeed,
  ): TSeed;

  export function reduceRight<T, TSeed>(
    source: T[] | IEnumerable<T>,
    callback: (seed: TSeed, element: T, index?: number) => TSeed,
    initialValue: TSeed,
  ): TSeed;
  ...
  export function selectMany<T, TElement, TResult>(
    source: T[] | IEnumerable<T>,
    collectionSelector: (
      element: T,
      index?: number,
    ) => TElement[] | IEnumerable<TElement> = defaultSelector,
    resultSelector: (
      sourceElement: T,
      collectionElement: TElement,
    ) => TResult = defaultResultSelector,
  ): IEnumerable<TResult>;
  export function selectMany<T, TElement, TResult>(
    source: T[] | IEnumerable<T>,
    collectionSelector: string | number | symbol,
    resultSelector: (
      sourceElement: T,
      collectionElement: TElement,
    ) => TResult = defaultResultSelector,
  ...
  export function sequenceEqual<T, TOther>(
    source: T[] | IEnumerable<T>,
    other: TOther[] | IEnumerable<TOther>,
    comparer: (element: T, other: TOther) => boolean = defaultEqualityComparer,
  ): boolean;
  ...
  export function skipSame<T>(
    source: T[] | IEnumerable<T>,
    comparer: (element: T, other: T) => boolean = defaultSameComparer,
  ): IEnumerable<T>;
  export function skipSame<T>(
    source: T[] | IEnumerable<T>,
    comparer: string | number | symbol,
  ...
  export function skipProportion<T>(
    source: T[] | IEnumerable<T>,
    proportion: number,
  ): IEnumerable<T>;
  ...
  export function takeProportion<T>(
    source: T[] | IEnumerable<T>,
    proportion: number,
  ): IEnumerable<T>;
  ...
  export function zip<T, TOther, TResult>(
    source: T[] | IEnumerable<T>,
    other: TOther[] | IEnumerable<TOther>,
    resultSelector: (element: T, other: TOther) => TResult,
  ): IEnumerable<TResult>;

  export function wipe<T>(
    source: T[] | IEnumerable<T>,
    predicate: (element: T, index?: number) => boolean = defaultPredicate,
    count: number = 0,
  ): IEnumerable<T>;
  ...
  export function nearBy<T, TKey, TElement, TResult>(
    source: T[] | IEnumerable<T>,
    keySelector: (element: T, index?: number) => TKey = defaultKeySelector,
    elementSelector: (
      element: T,
  ...
  export function separate<T, TResult>(
    source: T[] | IEnumerable<T>,
    childrenSelector: (
      element: T,
    ) => T[] | IEnumerable<T> = defaultChildrenSelector,
    valueSelector: (element: T) => TResult = defaultValueSelector,
  ): IEnumerable<TResult>;
  export function separate<T, TResult>(
    source: T[] | IEnumerable<T>,
    childrenSelector: string | number | symbol,
  ...
  export function combine<T, TKey, TValue>(
    source: T[] | IEnumerable<T>,
    parentSelector: (element: T) => TKey = defaultParentSelector,
    keySelector: (element: T) => TKey = defaultKeySelector,
    valueSelector: (element: T) => TValue = defaultSelector,
    comparer: (key: TKey, other: TKey) => boolean = defaultEqualityComparer,
  ): IEnumerable<ICombine<TKey, TValue>>;
  export function combine<T, TKey, TValue>(
    source: T[] | IEnumerable<T>,
    parentSelector: string | number | symbol,
    keySelector: (element: T) => TKey = defaultKeySelector,
    valueSelector: (element: T) => TValue = defaultSelector,
    comparer: (key: TKey, other: TKey) => boolean = defaultEqualityComparer,
  ): IEnumerable<ICombine<TKey, TValue>>;
  ...
  export function isSub<T>(
    source: T[] | IEnumerable<T>,
    other: T[] | IEnumerable<T>,
    comparer: (element: T, other: T) => boolean,
  ): boolean;
  export function isSub<T>(
    source: T[] | IEnumerable<T>,
    other: T[] | IEnumerable<T>,
  ...
  export function toDirectory<T, TKey, TValue>(
    source: T[] | IEnumerable<T>,
    keySelector: (element: T, index?: number) => TKey,
    valueSelector: (element: T, index?: number) => TValue,
    comparer: (element: TKey, other: TKey) => boolean = defaultSameComparer,
  ...
  export function toObject<T, TValue>(
    ...
    valueSelector: (element: T, index?: number) => TValue,
    comparer: (element: string, other: string) => boolean = defaultSameComparer,
  ): any;
  export function toObject<T, TValue>(
    source: T[] | IEnumerable<T>,
    keySelector: string | number | symbol,
  ...
  export const comparers: {
    ...
    array<T, TArray>(
      array: TArray[] | IEnumerable<TArray>,
      last: boolean = false,
      comparer: (
        element: TArray,
        other: T,
      ) => boolean = defaultEqualityComparer,
    ): (element: T, other: T) => number;
    array<T, TArray>(
      array: TArray[] | IEnumerable<TArray>,
      last: boolean = false,
      comparer: string | number | symbol,
    ...
    predicate<T>(
      predicateArray:
        | ((element: T) => boolean)[]
        | IEnumerable<(element: T) => boolean>,
      last = false,
    ): (element: T, other: T) => number;
    greater<T>(
      greaterThen: (element: T, other: T) => boolean,
      comparer: (element: T, other: T) => boolean = defaultEqualityComparer,
    ): (element: T, other: T) => number;
    greater<T>(
      greaterThen: (element: T, other: T) => boolean,
    ...
    ignoreCase<T>(
      selector: (element: T) => string = defaultSelector,
    ): (element: T, other: T) => boolean;
    ignoreCase<T>(
      selector: string | number | symbol,
    ): (element: T, other: T) => boolean;
  };
  ...
  export const predicates: {
    ...
    selector<T, TResult>(
      selector: (element: T, index?: number) => TResult,
      predicate: (element: TResult) => boolean = defaultExistsPredicate,
    ...
    not<T>(
      predicate: (
        element: T,
        index?: number,
      ) => boolean = defaultExistsPredicate,
    ): (element: T, index?: number) => boolean;
    not<T>(
      predicate: string | number | symbol | T | any,
    ): (element: T, index?: number) => boolean;
    ...
    regexp<T>(
      regexp: RegExp,
      keySelector: (element: T, index?: number) => string = defaultSelector,
    ): (element: T, index?: number) => boolean;
    regexp<T>(
      regexp: RegExp,
      keySelector: string | number | symbol,
  ...
  export interface IEnumerable<T> {
    ...
    asEnumerable<TValue>(
      childrenSelector: (element: T, index?: number) => T[] | IEnumerable<T>,
      valueSelector: (
        element: TValue,
        index?: number,
    ...
    innerJoin<TInner, TOuterKey, TInnerKey, TResult>(
      inner: TInner[] | IEnumerable<TInner>,
      resultSelector: (
        element: T,
        other: TInner,
    ...
    leftJoin<TInner, TOuterKey, TInnerKey, TResult>(
      inner: TInner[] | IEnumerable<TInner>,
      resultSelector: (
        element: T,
        grouping: IGrouping<TOuterKey, TInner>,
    ...
    rightJoin<TInner, TOuterKey, TInnerKey, TResult>(
      inner: TInner[] | IEnumerable<TInner>,
      resultSelector: (
        element: T,
        grouping: IGrouping<TOuterKey, TInner>,
  ...
  export interface IMapEnumerable<TKey, TValue>
    extends IEnumerable<Entry<TKey, TValue>> {
    forEach(
      action: (
        element: TValue,
        key: TKey,
  ...
  export interface Directory<TKey, TValue>
    extends IMapEnumerable<TKey, TValue> {
    delete(
      key: TKey,
      comparer: (element: TKey, other: TKey) => boolean,
    ): boolean;
  ...
  export interface Lookup<TKey, TElement>
    extends Directory<TKey, IEnumerable<TElement>> {
    set(
      key: TKey,
  ...
  export interface ITree<TValue> extends IEnumerable<ITree<TValue>> {
    ...
    breadthSearch(
      predicate: (element: TValue) => boolean = defaultPredicate,
    ): IEnumerable<TValue>;
    breadthSearch(
      predicate: string | number | symbol | TValue | any,
    ): IEnumerable<TValue>;
    breadthSubTree(
      predicate: (element: TValue) => boolean,
    ): IEnumerable<ITree<TValue>>;
    breadthSubTree(
      predicate: string | number | symbol | TValue | any,
    ): IEnumerable<ITree<TValue>>;
    ...
    toValue(
      childrenSetter: (
        obj: object,
        children: object[],
      ) => void = defaultChildrenSetter,
      valueSetter: (obj: object, value: TValue) => void = defaultValueSetter,
    ): object;
    toValue(
      childrenSetter: string | number | symbol,
      valueSetter: (obj: object, value: TValue) => void = defaultValueSetter,
    ): object;
    toValue(
      childrenSetter: (
      ...
      valueSetter: string | number | symbol,
    ): object;
    toValue(
      childrenSetter: string | number | symbol,
      valueSetter: string | number | symbol,
  ...
  export interface ICombine<TKey, TValue>
    extends IEnumerable<ICombine<TKey, TValue>>,
      ITree<TValue> {
    readonly key: TKey;
