...
class IOrderedEnumerable extends IEnumerable {
  constructor(source, orderByComparer = defaultComparer) {
    ...
    core.defineProperty(
      this,
      IOrderedEnumerable.ORDER_BY_COMPARER,
      () => orderByComparer,
      true,
    );
  }
  ...
  take(count) {
    return new TopEnumerable(
      this[IOrderedEnumerable.SOURCE],
      count,
      this[IOrderedEnumerable.ORDER_BY_COMPARER],
    );
  }
  skip(count) {
    return new BottomEnumerable(
      this[IOrderedEnumerable.SOURCE],
      count,
      this[IOrderedEnumerable.ORDER_BY_COMPARER],
    );
...
IOrderedEnumerable.ORDER_BY_COMPARER = Symbol(
  "IOrderedEnumerable.ORDER_BY_COMPARER",
);
