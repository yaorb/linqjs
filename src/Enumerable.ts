...
Enumerable.asEnumerable = function (
  object,
  childrenSelector,
  valueSelector = defaultValueSelector,
) {
...
Enumerable.toDictionary = function (
  source,
  keySelector = defaultSelector,
  elementSelector = defaultSelector,
  comparer = defaultSameComparer,
) {
  return asEnumerable(source).toDictionary(
    keySelector,
    elementSelector,
    comparer,
  );
};
Enumerable.toLookup = function (
  source,
  keySelector = defaultSelector,
  elementSelector = defaultSelector,
  comparer = defaultSameComparer,
...
Enumerable.orderBy = Enumerable.sorted = function (
  source,
  keySelector = defaultSelector,
...
Enumerable.thenByDescending = function (
  orderedSource,
  keySelector = defaultSelector,
  comparer = defaultComparer,
) {
...
Enumerable.groupBy = function (
  ...
  return asEnumerable(source).groupBy(
    keySelector,
    elementSelector,
    resultSelector,
    comparer,
...
Enumerable.selectMany =
  ...
  Enumerable.flatten =
    function (
      ...
      return asEnumerable(source).selectMany(
        collectionSelector,
        resultSelector,
      );
    };
Enumerable.join = function (
  outer,
  inner,
  resultSelector = defaultJoinSelector,
  ...
  if (arguments.length <= 2) {
    ...
    return asEnumerable(outer).join(
      inner,
      resultSelector,
      outerKeySelector,
      innerKeySelector,
...
Enumerable.innerJoin = Enumerable.joining = function (
  outer,
  inner,
  resultSelector = defaultJoinSelector,
  outerKeySelector = defaultSelector,
  ...
  return asEnumerable(outer).innerJoin(
    inner,
    resultSelector,
    outerKeySelector,
    innerKeySelector,
...
Enumerable.leftJoin = function (
  ...
  return asEnumerable(outer).leftJoin(
    inner,
    resultSelector,
    outerKeySelector,
    innerKeySelector,
...
Enumerable.rightJoin = function (
  ...
  return asEnumerable(outer).rightJoin(
    inner,
    resultSelector,
    outerKeySelector,
    innerKeySelector,
...
Enumerable.groupJoin = function (
  ...
  return asEnumerable(outer).groupJoin(
    inner,
    resultSelector,
    outerKeySelector,
    innerKeySelector,
...
Enumerable.copyWithin = function (
  source,
  target = 0,
  start = 0,
  end = Infinity,
...
Enumerable.all = Enumerable.allMatch = function (
  source,
  predicate = defaultPredicate,
) {
  return asEnumerable(source).all(predicate);
};
Enumerable.any = Enumerable.anyMatch = function (
  source,
  predicate = defaultPredicate,
) {
...
Enumerable.sequenceEqual = function (
  source,
  other,
  comparer = defaultEqualityComparer,
) {
...
Enumerable.firstOrDefault = function (
  source,
  defaultValue,
  predicate = defaultPredicate,
) {
...
Enumerable.lastOrDefault = function (
  source,
  defaultValue,
  predicate = defaultPredicate,
) {
...
Enumerable.singleOrDefault = function (
  source,
  defaultValue,
  predicate = defaultPredicate,
) {
...
Enumerable.maxOrDefault = function (
  source,
  defaultValue,
  selector = defaultSelector,
  comparer = defaultComparer,
...
Enumerable.minOrDefault = function (
  source,
  defaultValue,
  selector = defaultSelector,
  comparer = defaultComparer,
...
Enumerable.lastIndexOf = function (
  source,
  value,
  start = Infinity,
  comparer = defaultStrictEqualityComparer,
...
Enumerable.nearSplit = function (
  source,
  splitPredicate = defaultFalsePredicate,
) {
...
Enumerable.randomProbability = function (
  source,
  probabilitySelector = defaultSelector,
) {
  return asEnumerable(source).randomProbability(probabilitySelector);
};
Enumerable.randomIndexProbability = function (
  source,
  probabilitySelector = defaultSelector,
) {
  return asEnumerable(source).randomIndexProbability(probabilitySelector);
};
Enumerable.randomProbabilityOrDefault = function (
  source,
  defaultValue,
  probabilitySelector = defaultSelector,
) {
  return asEnumerable(source).randomProbabilityOrDefault(
    defaultValue,
    probabilitySelector,
  );
};
...
Enumerable.nearBy = function (
  ...
  return asEnumerable(source).nearBy(
    keySelector,
    elementSelector,
    resultSelector,
    comparer,
...
Enumerable.combine = function (
  ...
  return asEnumerable(source).combine(
    parentSelector,
    keySelector,
    valueSelector,
    comparer,
...
Enumerable.separate = function (
  source,
  childrenSelector = defaultChildrenSelector,
  valueSelector = defaultValueSelector,
) {
  return asEnumerable(source).separate(childrenSelector, valueSelector);
};
Enumerable.isSub = function (
  source,
  other,
  comparer = defaultEqualityComparer,
) {
...
Enumerable.bottom = function (
  source,
  count,
  orderByComparer = defaultComparer,
) {
  return asEnumerable(source).bottom(count, orderByComparer);
};
Enumerable.conflict = function (
  source,
  selector = defaultSelector,
  comparer = defaultEqualityComparer,
) {
